...
#
#####################################################################
### SCIPT TO META-CONFIGURE AND RUN CGENIE_Teaching ###################
#####################################################################
#
echo ""
#
...
if [ -z "$2" ]; then
    ...
    GOINDIR=$HOMEDIR/cgenie_Teaching/genie-userconfigs/"$2"
fi
...
CONFIGPATH=$HOMEDIR/cgenie_Teaching/genie-main/configs
CONFIGNAME=$RUNID".config"
BINARYPATH=$HOMEDIR/cgenie_Teaching/genie-main
RESTARTNAME="rst.1"
#
# (3) CHECK PARAMETERS
# --------------------------------------
